...
### Motivaiton
- People are complex and hence economics. There is a complex interplay between geography, culture and institutions that shape society
- **Hypothesis:** Danish railways brought modernity but also Grudtvigianism - so-called 'happy' Danes. Maybe they also smiled more?
...
---
# Railways and emotions - opening
.pull-left-narrow[
- TWFE of average emotions in parish on railway connection
- **NOTE:** Shanky imputation procedure to balance data. Needs to be fixed. 
- Need to run this in one of the new DiD estimators
- Very long run (100s of years!)
]
...
.center[<img src="Figures/Railways_on_emotions_opened/emotion_score_angry.png" width="75%" alt="Angry">]
]

.panel[.panel-name[Disgust]
.center[<img src="Figures/Railways_on_emotions_opened/emotion_score_disgust.png" width="75%" alt="Disgust">]
]

.panel[.panel-name[Fear]
.center[<img src="Figures/Railways_on_emotions_opened/emotion_score_fear.png" width="75%" alt="Fear">]
]

.panel[.panel-name[Happy]
.center[<img src="Figures/Railways_on_emotions_opened/emotion_score_happy.png" width="75%" alt="Happy">]
]

.panel[.panel-name[Neutral]
.center[<img src="Figures/Railways_on_emotions_opened/emotion_score_neutral.png" width="75%" alt="Neutral">]
]

.panel[.panel-name[Sad]
.center[<img src="Figures/Railways_on_emotions_opened/emotion_score_sad.png" width="75%" alt="Sad">]
]

.panel[.panel-name[Surprise]
.center[<img src="Figures/Railways_on_emotions_opened/emotion_score_surprise.png" width="75%" alt="Surprise">]
]
...
.panelset[
.panel[.panel-name[Angry]
.center[<img src="Figures/Railways_on_emotions_closed/emotion_score_angry.png" width="75%" alt="Angry">]
]

.panel[.panel-name[Disgust]
.center[<img src="Figures/Railways_on_emotions_closed/emotion_score_disgust.png" width="75%" alt="Disgust">]
]

.panel[.panel-name[Fear]
.center[<img src="Figures/Railways_on_emotions_closed/emotion_score_fear.png" width="75%" alt="Fear">]
]

.panel[.panel-name[Happy]
.center[<img src="Figures/Railways_on_emotions_closed/emotion_score_happy.png" width="75%" alt="Happy">]
]

.panel[.panel-name[Neutral]
.center[<img src="Figures/Railways_on_emotions_closed/emotion_score_neutral.png" width="75%" alt="Neutral">]
]

.panel[.panel-name[Sad]
.center[<img src="Figures/Railways_on_emotions_closed/emotion_score_sad.png" width="75%" alt="Sad">]
]

.panel[.panel-name[Surprise]
.center[<img src="Figures/Railways_on_emotions_closed/emotion_score_surprise.png" width="75%" alt="Surprise">]
]
